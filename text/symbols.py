...
# hi
hi_combined = ['ɗ', 'dː', 'ɑ', 'd̤', 'dz', 'j', 'ɖʱ', 'kʰ', 'ũː', 'ɛː', 'dʒʱ', 'nː', 'ʂ', 'ɖ', 'm', 'd̪', 'pʰ', 's', 'ɱ', 'w', 'b̤', 'ɓ', 'aː', 'ɪ', 'b', 'ɤ', 'tʼ', 'ɽʱ', 'p', 'iː', 'ə̃', 'k', 'ɦ', 'u', 'ɑː', 'ɒ', 'ẽː', 'ɫ', 'ĩː', 'eʰ', 'tsː', 'ts', 'n', 'tː', 'i', 'c', 'qʼ', 'ũ', 'bʱ', 'ɖ̤', 'ɡ̤', 't', 'θ', 'ɔː', 'ʕ', 'ɾ', 'tʃʰ', 'v', 't̪ʰ', 'ʊ̃', 'pː', 'ɠ', 'pʼ', 'q', 'tsʼ', 't̪', 'æ', 'ɡ', 'ð', 'ɛ̃ː', 'uː', 'χ', 'ʃ', 'ẽ', 'a', 'l̪', 'tʃ', 'tʰ', 'ʈʰ', 'ə̯', 'z', 'dʒ̤', 'l', 'ʄ', 'ɸ', 'ɛ', 'd̪ʱ', 'æː', 'tʃʼ', 'ɹ', 'ʈ', 'ɑ̃ː', 'h', 'ŋ', 'd', 't̪ː', 'ʊ', 'x', 'ɹ̩', 'ãː', 'ʁ', 'ʏ', 'ə', 'kʼ', 'ʃʰ', 'o', 'ɲ', 'f', 'e', 'ʔ', 'ɳ', 'dʒ', 'eː', 'ʌ', 'õː', 'r̩', 'sʰ', 'zː', 'ʒ', 'oː', 'ɕː', 'ã', 'ɔ', 'r', 'ɽ', 'ɡʱ', 'lː', 'ʋ', 'ɣ']
